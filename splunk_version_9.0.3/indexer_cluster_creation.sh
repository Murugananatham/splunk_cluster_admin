...
/opt/splunk/bin/splunk edit cluster-config -mode manager -replication_factor 2 -search_factor 2 -secret INDEXER_CLUSTER_SECRET_KEY -cluster_label INDEXER_CLUSTER_LABEL
...
# In Indexer 1
/opt/splunk/bin/splunk edit cluster-config -mode peer -manager_uri https://CLUSTER_MASTER_NODE_FQDN:8089 -replication_factor 9000 -secret INDEXER_CLUSTER_SECRET_KEY
